...
class UserRegistrationTwoScreen extends StatefulWidget {
  const UserRegistrationTwoScreen({super.key});

  @override
  _UserRegistrationTwoScreenState createState() => _UserRegistrationTwoScreenState();
}

class _UserRegistrationTwoScreenState extends State<UserRegistrationTwoScreen> {
  ...
  Widget build(BuildContext context) {
    var registrationController = Provider.of<UserRegistrationProvider>(context,listen: false);
    return WillPopScope(
      onWillPop: () async {
      ...
      child: CustomBackGround(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 5),
                  TextFormField(
                    controller: registrationController.postalCodeController,
                    style: const TextStyle(color: Colors.white),
                    decoration: InputDecoration(
                      contentPadding: const EdgeInsets.symmetric(horizontal: 12, vertical: -9),
                      hintText: '25000',
        ...
        bottom: Consumer<UserRegistrationProvider>(builder: (context, userRegistrationProvider, child) {
          return SizedBox(
            height:  MySize.size64,
            child: MyButton(
              width: 140,
              loading: userRegistrationProvider.loading,
              btnColor: Theme.of(context).primaryColor,
              onTap: () {
                userRegistrationProvider.registerUser(education: _selectedEducation);
              },
